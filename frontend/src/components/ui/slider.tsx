...
>(({ className, ...props }, ref) => (
  ...
  >
    ...
    <SliderPrimitive.Thumb className="z-20 block h-6 w-2 active:w-1 rounded-full bg-white outline outline-4 outline-[#16171b] focus-visible:ring-2 focus-visible:ring-[#16171b] transition-all duration-150 disabled:pointer-events-none disabled:opacity-50" />
  </SliderPrimitive.Root>
));
